if(null == Entities.FindByName(null, "count_text"))
{
    ...
    count_text.__KeyValueFromString("targetname", "");
...
if(null == Entities.FindByName(null, "count_relay"))
{
